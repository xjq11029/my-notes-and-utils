...
| [`frontend/`](frontend/) | 前端笔面试资料库：HTML/CSS、JS、TS、浏览器、Vue、React、工程化、性能、Node.js、实战、AI 辅助、跨端、架构、监控、测试（15 个模块） | 195 篇 | [README](frontend/README.md) |
| [`code-review/`](code-review/) | 供 Agent 加载的代码理解 / 代码审查指令规范（分析指南 + 审查指南 + 合并变更日志） | 4 篇 | [README](code-review/README.md) |
| [`learning/`](learning/) | 学习方法论：AI 辅助源码阅读、如何更好使用 AI 编程助手 | 2 篇 | [README](learning/README.md) |
| [`tools/`](tools/) | 工具链速查：VS Code 扩展清单 | 1 篇 | [README](tools/README.md) |

## 维护约定

- 每个子目录的 `README.md` 必须真实反映该目录实际情况，发现差异即时修正。
