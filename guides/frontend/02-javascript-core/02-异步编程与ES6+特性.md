...
> **本主题权威章节**：[完整讲解见 04-browser/02-事件循环与Web安全.md](../04-browser/02-事件循环与Web安全.md)；此处从 JS 异步编程视角展开要点。
...
> **本主题权威章节**：[完整讲解见 07-engineering/01-构建工具原理.md](../07-engineering/01-构建工具原理.md)；此处从 ES Module 静态结构视角展开要点。
