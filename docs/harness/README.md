...
| 文件 | 类型 | 说明 |
|---|---|---|
| `agent-harness-deep-dive.html` | 长文 · 精读版 | 单页自包含交互式深度讲解，约 3.9 万字，11 章（0–10）+ 附录 |
| `harness-from-principle-to-codex.md` | 长文 · 纯文本版 | 同一主题的 Markdown 长文，约 1580 行，11 节 + 附录；含精读版未覆盖的章节 |
...
| 篇幅 | 约 3.9 万字；11 章（0–10）+ 附录 | 约 1580 行；11 节 + 附录 |
...
| 章节 | 内容 |
|---|---|
| 0 | 先澄清术语：Harness 指什么（含"采样择优"这一旁支用法的辨析） |
| 1 | 底层思想：一个类比就能讲通 |
