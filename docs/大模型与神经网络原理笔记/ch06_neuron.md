...
| y | 输出值 / **激活值（activation）** | 一个标量 |
   ...
   ![笔记：MP 模型公式与各符号含义](<../2026-09-07%2012-15-43_doc/frames/frame_02-01-18.jpg>)
...
- 最著名的老牌激活函数：**与 0 取最大值**（即 ReLU 的思想）——小于 0 的结果没有意义，直接取 0；这个函数长期霸榜，训练小模型用它完全没问题；
...
- **结论：人工调参不可行**——而这只是**单个**神经元（几个参数）。
   ...
   ![可视化网页：单个神经元—贷款审批决策，调权重与偏置](<../2026-09-07%2012-15-43_doc/frames/frame_02-13-12.jpg>)
