...
| 阶段二 | `02-javascript-core/` | `01-语法基础与执行机制.md`、`02-异步编程与ES6+特性.md`、`03-常用API与手写原理.md`、`05-DOM操作与事件机制.md`、`06-JSON与网络请求.md`、`07-正则表达式.md`、`08-BOM与浏览器扩展API.md` | `04-JavaScript核心笔面试题集.md` |
| 阶段三 | `03-typescript/` + `04-browser/` | `01-TypeScript基础与类型系统.md`、`02-高级类型与工程配置.md`、`01-浏览器渲染与V8原理.md`、`02-事件循环与Web安全.md`、`04-网络协议基础.md` | `03-TypeScript笔面试题集.md`、`03-浏览器笔面试题集.md` |
...
| 阶段五 | `07-engineering/` + `08-performance/` | `01-构建工具原理.md`、`02-工程规范与流程.md`、`01-加载性能优化.md`、`02-运行时优化.md` | `03-前端工程化笔面试题集.md`、`03-性能优化笔面试题集.md` |
| 阶段六 | `09-nodejs/` + `10-project/` | `01-Node运行时与核心API.md`、`02-Web框架与BFF层.md`、`04-数据库与ORM.md`、`01-企业后台管理系统实战.md` | `03-Node.js笔面试题集.md` |
| 阶段七 | `11-ai-assisted/` | `01-AI编程工具与工作流.md`、`02-Prompt工程与代码生成.md`、`03-AI代码审查与质量管控.md` | — |
| 阶段八 | `12-cross-platform/` | `01-uniapp跨端开发基础.md`、`02-uniapp渲染差异与性能优化.md` | — |
...
>
> **学习辅助**：[知识导览](./知识导览.md) — 全部 63 个源文件的五维导览索引，快速查阅与复习。
...
完成阶段八学习后，你已经具备初中级前端工程师的能力。以下阶段九-十一为架构师进阶内容，详见下方各阶段完整规划：

- **阶段九：架构设计** — 微前端、设计系统、分层架构、技术管理
- **阶段十：监控与运维** — 前端监控体系、灰度发布、可观测性、故障排查
- **阶段十一：测试策略** — 测试金字塔、单元测试、组件测试、E2E 测试

此外，建议持续关注以下方向进行技术深度和广度拓展：源码阅读、数据结构与算法、性能极致优化、前端安全、可视化、实时通信、GraphQL、Web Components、PWA、Serverless、全栈框架、CSS 前沿等。
